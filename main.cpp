...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Growers-seeder\n"
    ...
    do {
        ...
        if (fStaticIPs4.good())
        {
            ...
            while (std::getline(fStaticIPs4, line))
            {
                ...
                db.Add(CAddress(CService(line+":11667"), true));
                printf("%s", line.c_str());
            }
        }
...
static const string mainnet_seeds[] = {"growerscoin-seeds.grwi.io", ""};
static const string testnet_seeds[] = {"growerscoin-testnet-seeds.grwi.io", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 11667), true);
  }
  do {
